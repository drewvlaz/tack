...
INSERT INTO item_images (id, item_id, r2_key, source_url, display_order, created_at, updated_at) VALUES
  ('img-1', 'item-1', 'items/item-1/img-1.jpg', 'https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=300&h=400&fit=crop&auto=format', 0, 1749168000, 1749168000),
  ('img-2', 'item-2', 'items/item-2/img-2.jpg', 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=300&h=400&fit=crop&auto=format', 0, 1749168000, 1749168000),
  ('img-3', 'item-3', 'items/item-3/img-3.jpg', 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=300&h=400&fit=crop&auto=format', 0, 1749168000, 1749168000);
